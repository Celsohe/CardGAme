namespace Code.Cards
{
    public sealed class Combat
    {
        ...
        /// Metodo  com as propriedades da classe CardPile chamado  Fight
        /// e que usa  duas variáveis.
        /// Responsável pela comparação entre as cartas.
        /// </summary>
        /// <param name="pileA">First pile used in combat </param>
        /// <param name="pileB"> Second Pile used in combat</param>
        /// <returns></returns>
        ...
        {
            // Propriedade pile  criada fora do metodo 
